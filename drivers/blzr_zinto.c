/* blzr_zinto.c - Subdriver for Zinto protocol based UPSes
 *
 * Copyright (C)
...
static item_t	zinto_blzr2nut[] = {
	...
	{ "device.mfr",			0,	NULL,	"FW?\r",	"",	39,	'#',	"",	1,	15,	"%s",	BLZR_FLAG_STATIC | BLZR_FLAG_TRIM,	NULL },
	{ "device.model",		0,	NULL,	"FW?\r",	"",	39,	'#',	"",	17,	26,	"%s",	BLZR_FLAG_STATIC | BLZR_FLAG_TRIM,	NULL },
	{ "ups.firmware",		0,	NULL,	"FW?\r",	"",	39,	'#',	"",	28,	37,	"%s",	BLZR_FLAG_STATIC | BLZR_FLAG_TRIM,	NULL },
