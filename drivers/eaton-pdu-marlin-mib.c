...
static info_lkp_t marlin_outlet_status_info[] = {
	...
	info_lkp_default(2, "pendingOff"),	/* transitional status */
	info_lkp_default(3, "pendingOn"),	/* transitional status */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_outletgroups_status_info[] = {
	info_lkp_default(0, "off"),
	info_lkp_default(1, "on"),
	info_lkp_default(2, "rebooting"),	/* transitional status */
	info_lkp_default(3, "mixed"),	/* transitional status, not sure what it means! */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_unit_switchability_info[] = {
	info_lkp_default(0, "no"),	/* unknown */
	info_lkp_default(1, "yes"),	/* switched */
	info_lkp_default(2, "no"),	/* advancedMonitored */
	info_lkp_default(3, "yes"),	/* managed */
	info_lkp_default(4, "no"),	/* monitored */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_ambient_presence_info[] = {
	...
	info_lkp_default(0, "no"),	/* disconnected */
	info_lkp_default(1, "yes"),	/* connected */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_threshold_frequency_status_info[] = {
	info_lkp_default(0, "good"),	/* No threshold triggered */
	info_lkp_default(1, "out-of-range"),	/* Frequency out of range triggered */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_threshold_voltage_alarms_info[] = {
	...
	info_lkp_default(1, "low voltage warning!"),	/* Warning low threshold triggered */
	info_lkp_default(2, "low voltage critical!"),	/* Critical low threshold triggered */
	info_lkp_default(3, "high voltage warning!"),	/* Warning high threshold triggered */
	info_lkp_default(4, "high voltage critical!"),	/* Critical high threshold triggered */
	info_lkp_sentinel
};

static info_lkp_t marlin_threshold_current_alarms_info[] = {
	info_lkp_default(0, ""),	/* No threshold triggered */
	info_lkp_default(1, "low current warning!"),	/* Warning low threshold triggered */
	info_lkp_default(2, "low current critical!"),	/* Critical low threshold triggered */
	info_lkp_default(3, "high current warning!"),	/* Warning high threshold triggered */
	info_lkp_default(4, "high current critical!"),	/* Critical high threshold triggered */
	info_lkp_sentinel
};

static info_lkp_t marlin_threshold_frequency_alarm_info[] = {
	info_lkp_default(0, ""),	/* No threshold triggered */
	info_lkp_default(1, "frequency out of range!"),	/* Frequency out of range triggered */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_outlet_group_type_info[] = {
	info_lkp_default(0, "unknown"),
	info_lkp_default(1, "breaker1pole"),
	info_lkp_default(2, "breaker2pole"),
	info_lkp_default(3, "breaker3pole"),
	info_lkp_default(4, "outlet-section"),
	info_lkp_default(5, "user-defined"),
	info_lkp_sentinel
};
...
static info_lkp_t marlin_outlet_group_phase_info[] = {
	info_lkp_fun_vp2s(1, "dummy"), marlin_outlet_group_phase_fun),
	info_lkp_sentinel
};
*/

static info_lkp_t marlin_outlet_group_phase_info[] = {
	info_lkp_default(0, "unknown"),	/* unknown     */
	info_lkp_default(1, "1"),	/* singlePhase */
	info_lkp_default(2, "1-N"),	/* phase1toN   */
	info_lkp_default(3, "2-N"),	/* phase2toN   */
	info_lkp_default(4, "3-N"),	/* phase3toN   */
	info_lkp_default(5, "1-2"),	/* phase1to2   */
	info_lkp_default(6, "2-3"),	/* phase2to3   */
	info_lkp_default(7, "3-1"),	/* phase3to1   */
	info_lkp_sentinel
};
...
static info_lkp_t marlin_device_count_info[] = {
	info_lkp_fun_s2l(1, "dummy", marlin_device_count_fun),
	info_lkp_sentinel
};
...
static snmp_info_t eaton_marlin_mib[] = {
	...
	snmp_info_default("ups.firmware", ST_FLAG_STRING, SU_INFOSIZE,
		...
		"", SU_FLAG_OK, NULL),
	snmp_info_default("ups.type", ST_FLAG_STRING, SU_INFOSIZE,
		NULL,
		"pdu", SU_FLAG_STATIC | SU_FLAG_ABSENT | SU_FLAG_OK, NULL),
	...
	snmp_info_default("input.count", 0, 1,
	...
	snmp_info_default("input.load", 0, 1.0,
		".1.3.6.1.4.1.534.6.6.7.3.3.1.11.%i.1.1",
		NULL, SU_FLAG_NEGINVALID | SU_FLAG_OK, NULL),
	snmp_info_default("input.L1.load", 0, 1.0,
		".1.3.6.1.4.1.534.6.6.7.3.3.1.11.%i.1.1",
		NULL, SU_FLAG_NEGINVALID | SU_FLAG_OK, NULL),
	snmp_info_default("input.L2.load", 0, 1.0,
		".1.3.6.1.4.1.534.6.6.7.3.3.1.11.%i.1.2",
		NULL, SU_FLAG_NEGINVALID | SU_FLAG_OK, NULL),
	snmp_info_default("input.L3.load", 0, 1.0,
	...
	snmp_info_default("input.voltage", 0, 0.001,
	...
	snmp_info_default("input.voltage.high.critical", ST_FLAG_RW, 0.001,
		...
		NULL, SU_FLAG_NEGINVALID, NULL),
	snmp_info_default("input.L1.voltage", 0, 0.001,
		".1.3.6.1.4.1.534.6.6.7.3.2.1.3.%i.1.1",
		NULL, 0, NULL),
	...
	snmp_info_default("input.L1.voltage.high.critical", ST_FLAG_RW, 0.001,
		".1.3.6.1.4.1.534.6.6.7.3.2.1.8.%i.1.1",
		NULL, SU_FLAG_NEGINVALID, NULL),
	snmp_info_default("input.L2.voltage", 0, 0.001,
	...
	snmp_info_default("input.L2.voltage.high.critical", ST_FLAG_RW, 0.001,
		...
		NULL, SU_FLAG_NEGINVALID, NULL),
	snmp_info_default("input.L3.voltage", 0, 0.001,
	...
	/* snmp_info_default("input.feed.%i.id", 0, 1, "???.%i.%i", NULL, SU_FLAG_NEGINVALID, NULL), */
...
/*
	snmp_info_default("input.%i.feed.desc", ST_FLAG_RW | ST_FLAG_STRING, SU_INFOSIZE,
		".1.3.6.1.4.1.534.6.6.7.3.1.1.10.%i.%i",
		NULL, SU_FLAG_SEMI_STATIC | SU_FLAG_OK | SU_TYPE_DAISY_1, NULL),
*/
	snmp_info_default("input.feed.desc", ST_FLAG_RW | ST_FLAG_STRING, SU_INFOSIZE,
...
*/
	...
	/* sensorCount.0 */
	snmp_info_default("ambient.count", ST_FLAG_RW, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.1.0",
		"0", SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* CommunicationStatus.n */
	snmp_info_default("ambient.%i.present", ST_FLAG_STRING, SU_INFOSIZE,
	...
	snmp_info_default("ambient.%i.name", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.3.1.1.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorManufacturer.n */
	snmp_info_default("ambient.%i.mfr", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.6.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorModel.n */
	snmp_info_default("ambient.%i.model", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.7.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorSerialNumber.n */
	snmp_info_default("ambient.%i.serial", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.9.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorUuid.n */
	snmp_info_default("ambient.%i.id", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.2.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorAddress.n */
	snmp_info_default("ambient.%i.address", 0, 1,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.4.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorMonitoredBy.n */
	snmp_info_default("ambient.%i.parent.serial", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.5.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* sensorFirmwareVersion.n */
	snmp_info_default("ambient.%i.firmware", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.1.2.1.10.%i",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* temperatureUnit.1
	 * MUST be before the temperature data reading! */
	snmp_info_default("ambient.%i.temperature.unit", 0, 1.0,
...
#if WITH_SNMP_LKP_FUN
	snmp_info_default("ambient.%i.temperature", 0, 0.1,
	...
	snmp_info_default("ambient.%i.temperature.low.critical", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.2.2.1.6.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* temperatureThresholdLowWarning.n.1 */
	snmp_info_default("ambient.%i.temperature.low.warning", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.2.2.1.5.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* temperatureThresholdHighWarning.n.1 */
	snmp_info_default("ambient.%i.temperature.high.warning", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.2.2.1.7.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* temperatureThresholdHighCritical.n.1 */
	snmp_info_default("ambient.%i.temperature.high.critical", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.2.2.1.8.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* humidityValue.n.1 */
	snmp_info_default("ambient.%i.humidity", 0, 0.1,
	...
	snmp_info_default("ambient.%i.humidity.low.critical", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.3.2.1.6.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* humidityThresholdLowWarning.n.1 */
	snmp_info_default("ambient.%i.humidity.low.warning", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.3.2.1.5.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* humidityThresholdHighWarning.n.1 */
	snmp_info_default("ambient.%i.humidity.high.warning", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.3.2.1.7.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* humidityThresholdHighCritical.n.1 */
	snmp_info_default("ambient.%i.humidity.high.critical", ST_FLAG_RW, 0.1,
		".1.3.6.1.4.1.534.6.8.1.3.2.1.8.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* digitalInputName.n.{1,2} */
	snmp_info_default("ambient.%i.contacts.1.name", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.4.2.1.1.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	snmp_info_default("ambient.%i.contacts.2.name", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.4.2.1.1.%i.2",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY, NULL),
	/* digitalInputPolarity.n */
	snmp_info_default("ambient.%i.contacts.1.config", ST_FLAG_RW | ST_FLAG_STRING, SU_INFOSIZE,
		".1.3.6.1.4.1.534.6.8.1.4.2.1.3.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY,
		&marlin_ambient_drycontacts_polarity_info[0]),
	snmp_info_default("ambient.%i.contacts.2.config", ST_FLAG_RW | ST_FLAG_STRING, SU_INFOSIZE,
		".1.3.6.1.4.1.534.6.8.1.4.2.1.3.%i.2",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY,
		&marlin_ambient_drycontacts_polarity_info[0]),
	/* XUPS-MIB::xupsContactState.n */
	snmp_info_default("ambient.%i.contacts.1.status", ST_FLAG_STRING, 1.0,
		".1.3.6.1.4.1.534.6.8.1.4.3.1.3.%i.1",
		"", SU_AMBIENT_TEMPLATE | SU_TYPE_DAISY_MASTER_ONLY,
		&marlin_ambient_drycontacts_state_info[0]),
	snmp_info_default("ambient.%i.contacts.2.status", ST_FLAG_STRING, 1.0,
	...
	snmp_info_default("outlet.id", 0, 1,
		NULL,
		"0", SU_FLAG_STATIC | SU_FLAG_ABSENT | SU_FLAG_OK, NULL),
	snmp_info_default("outlet.desc", ST_FLAG_RW | ST_FLAG_STRING, 20,
		NULL,
		"All outlets",
	...
	snmp_info_default("outlet.frequency", 0, 0.1,
		".1.3.6.1.4.1.534.6.6.7.3.1.1.3.%i.1",
		NULL, 0, NULL),
	snmp_info_default("outlet.voltage", 0, 0.001,
		".1.3.6.1.4.1.534.6.6.7.3.2.1.3.%i.1.1",
		NULL, 0, NULL),
	snmp_info_default("outlet.current", 0, 0.01,
		".1.3.6.1.4.1.534.6.6.7.3.3.1.4.%i.1.1",
		NULL, 0, NULL),
	snmp_info_default("outlet.realpower", 0, 1.0,
		".1.3.6.1.4.1.534.6.6.7.3.4.1.4.%i.1.4",
		NULL, 0, NULL),
	snmp_info_default("outlet.power", 0, 1.0,
		".1.3.6.1.4.1.534.6.6.7.3.4.1.3.%i.1.4",
		NULL, 0, NULL),
	...
	/* The fallback in firmwares issued before Sep 2017 (outletID), see details above: */
	snmp_info_default("outlet.%i.name", ST_FLAG_STRING, SU_INFOSIZE,
	...
	snmp_info_default("outlet.%i.realpower", 0, 1.0,
		...
		NULL, SU_OUTLET | SU_TYPE_DAISY_1, NULL),
	snmp_info_default("outlet.%i.voltage", 0, 0.001,
		".1.3.6.1.4.1.534.6.6.7.6.3.1.2.%i.%i",
		NULL, SU_OUTLET | SU_TYPE_DAISY_1, NULL),
	snmp_info_default("outlet.%i.voltage.status", ST_FLAG_STRING, SU_INFOSIZE,
	...
	snmp_info_default("outlet.%i.alarm", ST_FLAG_STRING, SU_INFOSIZE,
		...
		NULL, SU_OUTLET | SU_TYPE_DAISY_1,
		&marlin_threshold_voltage_alarms_info[0]),
	snmp_info_default("outlet.%i.voltage.low.warning", ST_FLAG_RW, 0.001,
		".1.3.6.1.4.1.534.6.6.7.6.3.1.4.%i.%i",
		NULL, SU_FLAG_NEGINVALID | SU_OUTLET | SU_TYPE_DAISY_1, NULL),
	snmp_info_default("outlet.%i.voltage.low.critical", ST_FLAG_RW, 0.001,
		".1.3.6.1.4.1.534.6.6.7.6.3.1.5.%i.%i",
		NULL, SU_FLAG_NEGINVALID | SU_OUTLET | SU_TYPE_DAISY_1, NULL),
	snmp_info_default("outlet.%i.voltage.high.warning", ST_FLAG_RW, 0.001,
		".1.3.6.1.4.1.534.6.6.7.6.3.1.6.%i.%i",
		NULL, SU_FLAG_NEGINVALID | SU_OUTLET | SU_TYPE_DAISY_1, NULL),
	snmp_info_default("outlet.%i.voltage.high.critical", ST_FLAG_RW, 0.001,
	...
	/* FIXME: SU_FLAG_SEMI_STATIC or SU_FLAG_SETTING =>
	 * refreshed from time to time or upon call to setvar */
	snmp_info_default("outlet.group.%i.desc", ST_FLAG_RW | ST_FLAG_STRING, SU_INFOSIZE,
	 ...
	 */
	/* FIXME: RFC on key name is needed when backporting to NUT upstream */
	snmp_info_default("outlet.group.%i.color", ST_FLAG_STRING, SU_INFOSIZE,
	 ...
	 */
	/* FIXME: RFC on key name is needed when backporting to NUT upstream */
	snmp_info_default("outlet.group.%i.input", 0, 1,
	...
	snmp_info_default("outlet.load.off", 0, DO_OFF, AR_OID_OUTLET_STATUS ".0",
		NULL, SU_TYPE_CMD, NULL),
	snmp_info_default("outlet.load.on", 0, DO_ON, AR_OID_OUTLET_STATUS ".0",
		NULL, SU_TYPE_CMD, NULL),
	snmp_info_default("outlet.load.cycle", 0, DO_CYCLE, AR_OID_OUTLET_STATUS ".0",
		NULL, SU_TYPE_CMD, NULL), */
	...
	snmp_info_default("outlet.group.%i.load.off", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.3.%i.%i",
		"0", SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
	/* groupControl0nCmd.0.1 = Integer: -1 */
	snmp_info_default("outlet.group.%i.load.on", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.4.%i.%i",
		"0", SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
	/* groupControlRebootCmd.0.1 = Integer: -1 */
	snmp_info_default("outlet.group.%i.load.cycle", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.5.%i.%i",
		"0", SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
	/* Delayed version, parameter is mandatory (so dfl is NULL)! */
	snmp_info_default("outlet.group.%i.load.off.delay", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.3.%i.%i",
		NULL, SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
	/* groupControl0nCmd.0.1 = Integer: -1 */
	snmp_info_default("outlet.group.%i.load.on.delay", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.4.%i.%i",
		NULL, SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
	/* groupControlRebootCmd.0.1 = Integer: -1 */
	snmp_info_default("outlet.group.%i.load.cycle.delay", 0, 1,
		".1.3.6.1.4.1.534.6.6.7.5.6.1.5.%i.%i",
		NULL, SU_TYPE_CMD | SU_OUTLET_GROUP | SU_TYPE_DAISY_1, NULL),
