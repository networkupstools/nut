...
static hid_info_t belkin_hid2nut[] = {
  ...
  { "input.sensitivity", ST_FLAG_RW | ST_FLAG_STRING, 0, "UPS.BELKINDevice.BELKINVoltageSensitivity", NULL, "%s", HU_FLAG_OK, belkin_sensitivity_conversion },
  { "input.transfer.high", ST_FLAG_RW | ST_FLAG_STRING, 0, "UPS.BELKINConfig.BELKINHighVoltageTransfer", NULL, "%.0f", HU_FLAG_OK, NULL },
  ...
  { "input.transfer.low", ST_FLAG_RW | ST_FLAG_STRING, 0, "UPS.BELKINConfig.BELKINLowVoltageTransfer", NULL, "%.0f", HU_FLAG_OK, NULL },
