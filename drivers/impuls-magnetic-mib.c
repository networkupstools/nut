...
#define IMPULS_MAGNETIC_MIB_UPSPOWER "1.3.6.1.4.1.935.1."
...
static snmp_info_t impuls_magnetic_mib[] = {
...
/* Input Group */
	...
	snmp_info_default("ups.load", 0, 0.1, IMPULS_MAGNETIC_MIB_UPSPOWER "1.1.4.2.2.0", "", 0, NULL), /* upsOutputPercentLoad */
...
mib2nut_info_t impuls_magnetic = {"impuls_magnetic", IMPULS_MAGNETIC_MIB_VERSION, IETF_OID_UPS_MIB "4.1.0", IETF_OID_UPS_MIB "1.1.0", impuls_magnetic_mib, IETF_SYSOID, NULL};
