/* nutdrv_qx_innovatae.c - Subdriver for INNOVA TAE series
 *
 * Copyright (C)
...
#define INNOVATAE_VERSION "INNOVATAE 0.01"

static void	innovatae_initups(void);

/* qx2nut lookup table */
static item_t	innovatae_qx2nut[] = {
	/* Static values */
	{ "device.mfr",			0,	NULL,	"",	"",	0,	'\0',	"",	0,	0,	"Ippon",	QX_FLAG_STATIC | QX_FLAG_ABSENT,NULL,	NULL,	NULL },
...
/* Testing table */
#ifdef TESTING
static testing_t	innovatae_testing[] = {
	{ "Q1\r",	"(215.0 195.0 230.0 014 49.0 22.7 30.0 00000000\r",	-1 },
	{ "Q\r",	"",	-1 },
	{ "F\r",	"#230.0 004 024.0 50.0\r",	-1 },
	{ "I\r",	"#222222222222222222222222222R1.00.48\r",	-1 },
	{ "S03\r",	"",	-1 },
	{ "C\r",	"",	-1 },
	{ "S02R0005\r",	"",	-1 },
	{ "S.5R0000\r",	"",	-1 },
...
static void	innovatae_initups(void)
{
	blazer_initups_light(innovatae_qx2nut);
}

/* Subdriver interface */
subdriver_t	innovatae_subdriver = {
	INNOVATAE_VERSION,
	blazer_claim_light,
	innovatae_qx2nut,
	innovatae_initups,
