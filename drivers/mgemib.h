...
static info_lkp_t mge_overbatt_info[] = {
	{ 1, "OVER" },
	{ 2, "" },
	{ 0, "NULL" }
};
...
snmp_info_t mge_mib[] = {
	...
	{ "ups.load", 0, 1, MGE_BASE_OID ".7.2.1.4.0", "", SU_FLAG_OK, NULL },
/*	{ "ups.delay.shutdown", ST_FLAG_STRING | ST_FLAG_RW, 3, MGE_OID_GRACEDELAY, "", SU_FLAG_OK, NULL }, */

	/* Input page */	
	{ "input.voltage", 0, 0.1, MGE_BASE_OID ".6.2.1.2.0", "", SU_FLAG_OK, NULL },
	{ "input.voltage.minimum", 0, 0.1, MGE_BASE_OID ".6.2.1.4.0", "", SU_FLAG_OK, NULL },
	{ "input.voltage.maximum", 0, 0.1, MGE_BASE_OID ".6.2.1.5.0", "", SU_FLAG_OK, NULL },
	{ "input.frequency", 0, 0.1, MGE_BASE_OID ".6.2.1.3.0", "", SU_FLAG_OK, NULL },

	/* Output page */
	{ "output.voltage", 0, 0.1, MGE_BASE_OID ".7.2.1.2.0", "", SU_FLAG_OK, NULL },
	{ "output.frequency", 0, 0.1, MGE_BASE_OID ".7.2.1.3.0", "", SU_FLAG_OK, NULL },
