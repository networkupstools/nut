 ...
 * All rights reserved.*
 ...
 Gavrilov Igor 2014  - modified to support external vars (setting EBM number, nominal output voltage, beeper status, sleep mode, etc.),
 Added ABM Status indication for internal batteries.
...
TODO List:
	...
	Get list of supported variables from UPS (init_ext_vars())
	 ...
	 if (!strcasecmp(cmdname, "beeper.disable") || !strcasecmp(cmdname, "beeper.enable") || !strcasecmp(cmdname, "beeper.mute")) {
		...
		cbuf[3] = 0x0;		/*padding*/
                ...
                switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Beeper state changed");
                                return STAT_INSTCMD_HANDLED;
                                break;
                                }
                        case 0x33: {
...
int setvar (const char *varname, const char *val)
{
         ...
         if (!strcasecmp(varname, "input.transfer.boost.high")) {
                ...
                if (res <= 0) {
                 ...
                 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"BOOST threshold volage set to %d V", tmp);
         ...
         if (!strcasecmp(varname, "input.transfer.trim.low")) {
                ...
                if (res <= 0) {
                 ...
                 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"TRIM threshold volage set to %d V", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
	...
	if (!strcasecmp(varname, "ups.low.batt.delay")) {
		...
		cbuf[3]=0x0;
		 ...
		 res = command_write_sequence(cbuf, 4, answer);
	        ...
	        switch ((unsigned char) answer[0]) {
	                ...
	                case 0x31: {
        	                upslogx(LOG_NOTICE,"Low batterry warning time set to %d min", tmp);
	                        return STAT_SET_HANDLED;
        	                break;
                	        }
	                case 0x33: {
        ...
        if (!strcasecmp(varname, "ups.return.delay")) {
                ...
                switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Mains return delay set to %d sec", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
		...
		switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Mains return minimum battery capacity set to %d %%", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
        ...
        if (!strcasecmp(varname, "ambient.temperature.high")) {
                ...
                if (res <= 0) {
                 ...
                 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Maximum temperature set to %d C", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
		 ...
		 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Nominal output volage set to %d V", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
         ...
         if (!strcasecmp(varname, "ups.sleep.min.load")) {
                ...
                if (res <= 0) {
                 ...
                 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Minimum load before sleep set to %d %%", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
		 ...
		 switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Delay before entering sleep mode set to %d min", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
	 ...
	 if (!strcasecmp(varname, "battery.packs")) {
                ...
                switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"EBM count set to %d min", tmp);
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
	...
	if ( (!strcasecmp(namebuf, "outlet.n.delay.start")) ||
        ...
        if ( !strcasecmp(namebuf, "outlet.n.status") ) {
                ...
                cbuf[0] = tmp?PW_UPS_ON:PW_UPS_OFF;        /* Cmd */
                ...
                switch ((unsigned char) answer[0]) {
                        ...
                        case 0x31: {
                                upslogx(LOG_NOTICE,"Outlet %d is  %s",outlet_num, tmp?"On":"Off");
                                return STAT_SET_HANDLED;
                                break;
                                }
                        case 0x33: {
