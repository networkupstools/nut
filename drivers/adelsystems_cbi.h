/*  adelsystems_cbi.h - Driver for ADELSYSTEMS CB/CBI DC-UPS
 *
 *  Copyright (C)
...
#ifndef ADELSYSTEMS_CBI_H
#define ADELSYSTEMS_CBI_H

#include <stdint.h>

/* UPS device details */
#define DEVICE_MFR  "ADELSYSTEMS"
