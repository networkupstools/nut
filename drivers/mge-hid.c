...
#define MGE_HID_VERSION		"MGE HID 1.34"
...
static hid_info_t mge_hid2nut[] =
{
	...
	{ "ups.load.energysave", ST_FLAG_RW | ST_FLAG_STRING, 5, "UPS.PowerConverter.Input.[3].ConfigPercentLoad", NULL, "%.0f", HU_FLAG_SEMI_STATIC, NULL },
