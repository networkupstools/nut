...
static hid_info_t mge_hid2nut[] =
{
	...
	{ "driver.version.internal", ST_FLAG_STRING, 5,
		NULL, NULL, DRIVER_VERSION,
		HU_FLAG_ABSENT | HU_FLAG_OK, NULL },
	{ "driver.version.data", ST_FLAG_STRING, 11,
	...
	{ "ups.test.result", 0, 0,
		...
		HU_FLAG_OK | HU_FLAG_SEMI_STATIC, &test_read_info[0] },
	...
	{ "ups.beeper.status", 0, 1,
		...
		HU_FLAG_OK | HU_FLAG_SEMI_STATIC, &beeper_info[0] },
	{ "ups.temperature", 0, 0, 
		"UPS.PowerSummary.Temperature", NULL, "%.1f",
		HU_FLAG_OK, NULL },
	{ "ups.power", ST_FLAG_STRING, 5,
		"UPS.PowerConverter.Output.ApparentPower", NULL, "%.0f",
		HU_FLAG_OK, NULL },
	{ "ups.power.nominal", ST_FLAG_STRING, 5,
		"UPS.Flow.[4].ConfigApparentPower", NULL, "%.0f",
		HU_FLAG_OK | HU_FLAG_STATIC, NULL },
	{ "ups.realpower", ST_FLAG_STRING, 5,
	...
	{ "outlet.0.switchable", 0, 0,
		...
		HU_FLAG_OK | HU_FLAG_STATIC, &yes_no_info[0] },
	{ "outlet.1.id", 0, 0,
	...
	{ "outlet.2.switchable", 0, 0,
		...
		HU_FLAG_OK | HU_FLAG_STATIC, &yes_no_info[0] },
	{ "outlet.2.status", ST_FLAG_STRING, 3,
