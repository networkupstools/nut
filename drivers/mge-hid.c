...
static hid_info_t mge_hid2nut[] =
{
	...
	/* input.transfer.forced = 1 needs for Auto Bypass Switch On/Off */
	...
	/* Transfer on automatic Bypass switch with rules x.OverloadTransferEnable and x.OutOfToleranceTransferEnable */
