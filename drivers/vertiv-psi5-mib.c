/* drivers/vertiv-psi5-mib.c - Driver for Vertiv Liebert PSI5 UPS
 *
 *	Copyright (C)
 *
...
/* Vertiv PSI5-750MT120 Mapping 
   Based on integer branch at .1.3.6.1.4.1.476.1.42.3.9.30... */
...
static snmp_info_t vertiv_psi5_mib[] = {
	...
	{ "battery.runtime", 0, SU_INFOTYPE_INT, NULL,
		...
		NULL, NULL }, /* Note: Raw value is minutes, NUT usually expects seconds */
