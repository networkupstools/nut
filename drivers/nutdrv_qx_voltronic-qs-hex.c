...
#define VOLTRONIC_QS_HEX_VERSION "Voltronic-QS-Hex 0.01"
...
static item_t	voltronic_qs_hex_qx2nut[] = {
	...
	{ "ups.alarm",			0,	NULL,	"QS\r",	"",	47,	'#',	"",	44,	44,	NULL,	0,			voltronic_qs_hex_preprocess_qs_answer,	blazer_process_status_bits },	/* Shutdown Active */
