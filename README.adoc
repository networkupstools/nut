...
:linkman_apcupsd-ups-8:		linkman:apcupsd-ups[8]
:linkman_genericups-8:		linkman:genericups[8]
:linkman_nutdrv_qx-8:		linkman:nutdrv_qx[8]
:linkman_powerman-pdu-8:	linkman:powerman-pdu[8]
:linkman_snmp-ups-8:		linkman:snmp-ups[8]
:linkman_upsc-8:		linkman:upsc[8]
:linkman_upsd-users-5:		linkman:upsd.users[5]
:linkman_upsmon-8:		linkman:upsmon[8]
:linkman_usbhid-ups-8:		linkman:usbhid-ups[8]
endif::env-github[]
// - on GitHub:
ifdef::env-github[]
//   * xref -> link
...
:man-url:			{website-url}docs/man/
:linkman_apcupsd-ups-8:		{man-url}apcupsd-ups.html[apcupsd-ups(8)]
:linkman_genericups-8:		{man-url}genericups.html[genericups(8)]
:linkman_nutdrv_qx-8:		{man-url}nutdrv_qx.html[nutdrv_qx(8)]
:linkman_powerman-pdu-8:	{man-url}powerman-pdu.html[powerman-pdu[8)]
:linkman_snmp-ups-8:		{man-url}snmp-ups.html[snmp-ups(8)]
:linkman_upsc-8:		{man-url}upsc.html[upsc(8)]
:linkman_upsd-users-5:		{man-url}upsd.users.html[upsd.users[5)]
:linkman_upsmon-8:		{man-url}upsmon.html[upsmon(8)]
:linkman_usbhid-ups-8:		{man-url}usbhid-ups.html[usbhid-ups(8)]
endif::env-github[]
...
supports it.
+
See the {linkman_genericups-8} man page for more information.
...
+
See the {linkman_usbhid-ups-8} man page for more information.
...
+
See the {linkman_nutdrv_qx-8} man page for more information.
...
+
See the {linkman_snmp-ups-8} man page for more information.
...
+
See the {linkman_powerman-pdu-8} man page for more
information.
...
+
See the {linkman_apcupsd-ups-8} man page for more information.
...
You should read the {xref}Outlets_PDU_notes{x-s}[Configuring automatic UPS shutdowns]
...
See the {linkman_upsc-8} man page and
...
Refer to {linkman_upsd-users-5} for information on defining
users in `upsd`.
