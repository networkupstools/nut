...
| image:images/ci/OC_logo-watercolor-256.png[alt="Open Collective
  logo",width="32",height="32",link="https://opencollective.com/"]&nbsp;image:images/ci/OC_logotype.png[alt="Open
  Collective logo",width="137",height="23",link="https://opencollective.com/"]
