...
ifndef::pdf_format[]
image:https://star-history.dera.page/svg?repos=networkupstools/nut&type=Date[link="https://star-history.dera.page/#networkupstools/nut&Date" alt="NUT GitHub Star History Chart"]
endif::pdf_format[]
