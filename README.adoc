...
|===
| image:images/ci/GitHub-Mark-ea2971cee799.png[GitHub logo,140,140]
...
| image:images/ci/jenkins-nut-transparent-bg.png[Jenkins+NUT logo,140]
...
| image:images/ci/CircleCI_vertical_black_logo.svg[CircleCI logo]
| The
...
| image:images/ci/AppVeyor_logo-2x.png[AppVeyor logo]
...
| image:images/ci/DO_Powered_by_Badge_blue.svg[DigitalOcean logo,140,30]
...
| image:images/ci/gandi-ar21.svg[Gandi.Net logo]
| link:https://www.gandi.net/[Gandi.Net] took up the costs of NUT DNS hosting.

| image:images/ci/OC_logotype.svg[Open Collective logo]
