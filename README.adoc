...
//GH_MARKUP_1095//endif::top_srcdir[]
//GH_MARKUP_1095_INCLUDE_BEGIN//146694cff (2023-09-13) docs/asciidoc-vars.conf: prepare for GH_MARKUP_1095 workarounds
...
// sources by maintenance recipes directly, due to current limitations
// of the GitHub asciidoc renderer. Hopefully it can be dropped after
// this issue is resolved on their side:
...
// * `env-github` is used as a boolean toggle, set by GitHub WebUI renderer
