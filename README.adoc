...
//GH_MARKUP_1095//endif::top_srcdir[]
//GH_MARKUP_1095_INCLUDE_BEGIN//234b70422 (2023-09-13) docs/asciidoc-vars.conf: finish the file with newline
...
// Hopefully it can be dropped after this issue is resolved on their side:
