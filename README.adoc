...
| image:images/ci/openSUSEBuildService.png[alt="openSUSE Build Service logo",width="157",height="30",link="https://build.opensuse.org/"]
| The several branches of
  ...
  number of Linux distributions, as well as test NUT PR and stable branch
  iterations on those across several CPU architectures.
