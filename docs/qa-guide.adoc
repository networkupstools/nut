...
For now, see the "Continuous Integration and Automated Builds" chapter
of `developers.txt` in NUT sources, section "Pre-set warning options".
...
For now, see the "Continuous Integration and Automated Builds" chapter
of `developers.txt` in NUT sources, section "ci_build.sh".
