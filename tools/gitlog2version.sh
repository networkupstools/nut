...
# This file is absent in Git, but should be provided in tarballs.
# It may be re-generated by NUT autogen.sh script forcibly, but is
# otherwise preferred if present and NUT source dir is not a git
