...
sub gen_usb_files
{
	...
	print $outputUPower '# This file was automatically generated by NUT (nut/tools/nut-usbinfo.pl)'."\n";
	print $outputUPower '# to keep up to date, monitor upstream NUT https://github.com/networkupstools/nut/commits/master/scripts/upower/95-upower-hid.rules'."\n";
	print $outputUPower '# and upstream UPower http://cgit.freedesktop.org/upower/tree/rules/95-upower-hid.rules'."\n\n";
