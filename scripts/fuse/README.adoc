...
You can also prepare an environment using NUT Integration Tests (NIT) scripts:
----
...
----
:; grep -rH . /tmp/nut-fuse/by-server/localhost/dummy
/tmp/nut-fuse/by-server/localhost/dummy/battery.charge:100
/tmp/nut-fuse/by-server/localhost/dummy/battery.charge.low:20
/tmp/nut-fuse/by-server/localhost/dummy/battery.runtime:1456
/tmp/nut-fuse/by-server/localhost/dummy/battery.type:PbAc
...
----
