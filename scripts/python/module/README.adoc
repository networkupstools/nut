...
type `pydoc PyNUT` to obtain succint documentation on your current version of
the module.
...
identification such as version, product or distribution it may be bunded with.
