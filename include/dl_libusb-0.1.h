 ...
 * @return @ref FALSE, on errors, with the reason of the failure stored in *error* and @ref dl_libusb01_handle set to `(void *)1`. */
static inline bool_t	dl_libusb01_init(
