		...
		if (relpath_strlen > len_PREFIX
		 ...
		 && *(relative_path + len_PREFIX + 1) == '/'
			...
			if (win_PREFIX == NULL) {
				...
				while ( (last_slash = strrchr(last_slash, '/')) ) {
					*last_slash = '\\';
				}
			}
			...
			if (prefix_in_buf &&
				...
				for (last_slash = prefix_in_buf + len_PREFIX + 2; last_slash; last_slash++) {
